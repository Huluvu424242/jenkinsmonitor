...
[quote]
____
Wer die Vergangenheit kontrolliert, kontrolliert die Zukunft. Wer die Gegenwart kontrolliert, kontrolliert die Vergangenheit.  -Georg Orwell
____
...
[source, properties]
----
include::src/test/resources/jenkinsmonitor.properties[]
----
