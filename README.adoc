...
Dieses Projekt folgt den unter https://funthomas424242.github.io/jenkinsmonitor/code-of-conduct.txt[Verhaltenskodex,role=external,window=_blank] abgelegten Verhaltensregeln. Welche auch unter https://www.contributor-covenant.org/de/version/1/4/code-of-conduct/[Verhaltenskodex für Unterstützer] veröffentlicht wurden.
