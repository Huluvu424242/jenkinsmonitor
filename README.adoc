...
nicht nur kostenlos. Mein Beitrag und meine Hommage zu 20 Jahre Open Source.

Feature die ich mir vom Projekt wünsche und eben auch umsetzen möchte:
...
* Rechtsklick: Statusanzeige & Settings.
