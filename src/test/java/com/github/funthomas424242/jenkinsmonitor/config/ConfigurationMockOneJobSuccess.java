...
public class ConfigurationMockOneJobSuccess {
    ...
    private ConfigurationMockOneJobSuccess() {
    }

    public static Created getOrCreateInstance(){
        return Configuration.getOrCreateInstance(ConfigurationMockOneJobSuccess.getConfigFile());
    }
