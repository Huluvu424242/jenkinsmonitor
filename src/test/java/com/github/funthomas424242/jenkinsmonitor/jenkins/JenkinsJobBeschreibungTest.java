...
class JenkinsJobBeschreibungTest {
    ...
    protected void checkEqualsAndHashCode() {
        EqualsVerifier.forClass(JenkinsJobBeschreibung.class)
    ...
    void valideInitialisierung() {
        final JenkinsJobBeschreibung jenkinsJobBeschreibung
            = new JenkinsJobBeschreibung(LOCALHOST_JOB_TEST_URL);
        assertNotNull(jenkinsJobBeschreibung);
        assertEquals(LOCALHOST_JOB_TEST_URL, jenkinsJobBeschreibung.getJobUrl());
    }
